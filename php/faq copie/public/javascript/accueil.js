...
function imgchange(){
    ...
    if(a===0) {
        ...
        img1.setAttribute('src','public/assets/zebre.4.png')
        a=1
        
    }else if (a===1){
        img1.setAttribute('src','public/assets/elephant.7.jpg')
        a=2
    }else {
        img1.setAttribute('src','public/assets/elephant.6.jpeg')
        a=0
    }
